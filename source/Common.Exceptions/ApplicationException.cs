...
namespace Ignite.Framework.Micro.Common.Exceptions
{
    ...
    public class ApplicationException : BaseException
    {
        ...
        /// </param>
        public ApplicationException(string message, Exception innerException, ErrorCode errorCode = null) : base(message, innerException, errorCode)
        {
        }
        ...
        /// The error code for the exception.
        /// </param>
        public ApplicationException(string message, ErrorCode errorCode = null)  : base(message, errorCode)
        {
        }
    }
}
